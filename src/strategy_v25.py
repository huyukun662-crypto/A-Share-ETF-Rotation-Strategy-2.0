...
# Self-contained: 所有数据在仓内 cache/
REPO_ROOT = Path(__file__).resolve().parents[1]
V15_ROOT = REPO_ROOT  # 兼容 V18 OHLC 路径

WEEKLY_V7 = REPO_ROOT / 'cache' / 'etf_weekly.parquet'
WEEKLY_V12 = REPO_ROOT / 'cache' / 'etf_weekly_v12.parquet'
UNI_V7 = REPO_ROOT / 'cache' / 'etf_universe.csv'
...
def _load_data(weekly_path=None, uni_path=None, csi_path=None):
    ...
    # === OHLC 周线（V18 日内因子）===
    ohlc_path = REPO_ROOT / 'cache' / 'etf_weekly_ohlc.parquet'
